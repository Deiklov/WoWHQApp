...
public class AuctionListRecyclerViewAdapter extends RecyclerView.Adapter<AuctionListRecyclerViewAdapter.ViewHolder> {
    ...
    public AuctionListRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_auctionlist_lot, parent, false);
